                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('producto_id', \App\Producto::where('servicio',0)->pluck('nombre','id'), null, ['class' => 'form-control', 'placeholder' => 'Selección']) !!}
                        ...
                        {{ Form::button('<i class="fas fa-sticky-note"></i> Actualizar', ['type' => 'submit', 'class' => 'btn btn-info btn-sm text-white mr-3'] )  }}
